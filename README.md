...
## サンプルプログラム
  ...
  サンプルプログラムの動作については、Arduino IDE 1.8.16、ボードマネージャの M5Stack のバージョンは 1.0.9、ライブラリは以下の各バージョンで確認しています。  
  M5Stack 製品の Arduino IDE 環境でのセットアップについては、以下公式のクイックスタートガイドを参照ください。  

  * [M5StickC][13]: Ver.0.2.4
  * [M5StickC Plus][14]: Ver.0.0.1
  * [M5-CoreInk][15]: Ver.0.0.2
